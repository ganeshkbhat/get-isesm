...
describe('test-.mjs::require-urls: Test Suite for require-urls Files', function() {
    describe ('test-.js::require-urls: [Test A] Test Suite for require-urls in main repo directory', function() {
        ...
        it('[Test A] Test for all imports of __filename using _importRegex', function(done) {
            let arr = parser._importRegex(__filename);
        ...
        it('[Test A] Test for all imports of ./demos/parser.imports.regex.js using _importRegex', function(done) {
